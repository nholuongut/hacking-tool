...
- [WordlistCreator](https://github.com/nholuongut/wlcreator)
...
- [EvilTwin](https://github.com/nholuongut/fakeap)
- [Fastssh](https://github.com/nholuongut/fastssh)
- Howmanypeople
### SQL Injection Tools
...
![](https://github.comnholuongut/hacking-tool/blob/master/images/A00.png)
![](https://github.comnholuongut/hacking-tool/blob/master/images/A0.png)
![](https://github.comnholuongut/hacking-tool/blob/master/images/A1.png)
![](https://github.comnholuongut/hacking-tool/blob/master/images/A2.png)
![](https://github.comnholuongut/hacking-tool/blob/master/images/A4.png)
...
## Step : 1 Download hacking-tool

    git clone https://github.com/nholuongut/hacking-tool.git

## Step : 2 Give Permission to hacking-tool
    
    chmod -R 755 hacking-tool  

## Step : 3 Move to hacking-tool directory

    cd hacking-tool

## Step : 4 Run hacking-tool
...
```bash
docker buitl -t vgpastor/hacking-tool .
```
...
```bash
docker exec -it hacking-tool bash
```
**OUTPUT:**
```bash
Select Best Option : 
...
#### Thanks to original Author of the tools used in hacking-tool
