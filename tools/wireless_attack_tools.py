...
class EvilTwin(HackingTool):
    ...
    INSTALL_COMMANDS = ["sudo git clone https://github.com/nholuongut/fakeap.git"]
    RUN_COMMANDS = ["cd fakeap && sudo bash fakeap.sh"]
    PROJECT_URL = "https://github.com/nholuongut/fakeap"
...
class Fastssh(HackingTool):
    ...
    INSTALL_COMMANDS = [
        "sudo git clone https://github.com/nholuongut/fastssh.git && cd fastssh && sudo chmod +x fastssh.sh",
        "sudo apt-get install -y sshpass netcat"
    ]
    RUN_COMMANDS = ["cd fastssh && sudo bash fastssh.sh --scan"]
    PROJECT_URL = "https://github.com/nholuongut/fastssh"
